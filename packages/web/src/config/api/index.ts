...
export const api = {
   ...
   * with vue: https://yobaji.github.io/vue3-google-login/#credentialcallback
   * */
  auth: {
    googleAuthSubCallback: (credential: string) => {
      return apiService.get<{ token?: string }>(`/auth/google/callback?credential=${credential}`)
    }
  }
} as const
